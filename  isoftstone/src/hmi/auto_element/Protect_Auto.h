#ifndef CLASS_PROTECT_AUTO_H
#define CLASS_PROTECT_AUTO_H
...
struct Protect_Struct
{
	...
	Protect_Struct& operator=(const Protect_Struct& cp)
	{
		this->af = 		cp.af;
		this->app = 		cp.app;
...
class CProtect_Auto : public ISerialize,public GSerialize,public CGraphicsItemBase 
{
public:
	...
	Protect_Struct getInfo()
	{
		return m_Info;
	}
protected:

	Protect_Struct m_Info ;
};
