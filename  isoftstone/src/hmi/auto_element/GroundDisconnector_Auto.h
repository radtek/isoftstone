#ifndef CLASS_GROUNDDISCONNECTOR_AUTO_H
#define CLASS_GROUNDDISCONNECTOR_AUTO_H
...
struct GroundDisconnector_Struct
{
	uint  af;
	QString  devref;
	QColor  fc;
	...
	GroundDisconnector_Struct& operator=(const GroundDisconnector_Struct& cp)
	{
		this->af = 		cp.af;
...
class CGroundDisconnector_Auto : public ISerialize,public GSerialize,public CGraphicsItemBase 
{
public:
	...
	GroundDisconnector_Struct getInfo()
	{
		return m_Info;
	}
protected:

	GroundDisconnector_Struct m_Info ;
};
