#ifndef CLASS_DISCONNECTOR_AUTO_H
#define CLASS_DISCONNECTOR_AUTO_H
...
struct Disconnector_Struct
{
	...
	Disconnector_Struct& operator=(const Disconnector_Struct& cp)
	{
		this->af = 		cp.af;
		this->app = 		cp.app;
...
class CDisconnector_Auto : public ISerialize,public GSerialize,public CGraphicsItemBase 
{
public:
	...
	Disconnector_Struct getInfo()
	{
		return m_Info;
	}
protected:

	Disconnector_Struct m_Info ;
};
