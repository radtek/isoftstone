#ifndef CLASS_OTHER_AUTO_H
#define CLASS_OTHER_AUTO_H
...
struct Other_Struct
{
	...
	Other_Struct& operator=(const Other_Struct& cp)
	{
		this->af = 		cp.af;
		this->app = 		cp.app;
...
class COther_Auto : public ISerialize,public GSerialize,public CGraphicsItemBase 
{
public:
