#ifndef CLASS_REACTOR_AUTO_H
#define CLASS_REACTOR_AUTO_H
...
struct Reactor_Struct
{
	...
	Reactor_Struct& operator=(const Reactor_Struct& cp)
	{
		this->af = 		cp.af;
		this->app = 		cp.app;
...
class CReactor_Auto : public ISerialize,public GSerialize,public CGraphicsItemBase 
{
public:
	...
	Reactor_Struct getInfo()
	{
		return m_Info;
	}
protected:

	Reactor_Struct m_Info ;
};
