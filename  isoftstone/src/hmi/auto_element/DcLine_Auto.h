#ifndef CLASS_DCLINE_AUTO_H
#define CLASS_DCLINE_AUTO_H
...
struct DcLine_Struct
{
	...
	DcLine_Struct& operator=(const DcLine_Struct& cp)
	{
		this->af = 		cp.af;
		this->app1 = 		cp.app1;
		this->app2 = 		cp.app2;
...
class CDcLine_Auto : public ISerialize,public GSerialize,public CGraphicsItemBase 
{
public:
	...
	DcLine_Struct getInfo()
	{
		return m_Info;
	}
protected:

	DcLine_Struct m_Info ;
};
