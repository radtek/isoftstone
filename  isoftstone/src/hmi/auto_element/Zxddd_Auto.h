#ifndef CLASS_ZXDDD_AUTO_H
#define CLASS_ZXDDD_AUTO_H
...
struct Zxddd_Struct
{
	...
	Zxddd_Struct& operator=(const Zxddd_Struct& cp)
	{
		this->af = 		cp.af;
...
class CZxddd_Auto : public ISerialize,public GSerialize,public CGraphicsItemBase 
{
public:
