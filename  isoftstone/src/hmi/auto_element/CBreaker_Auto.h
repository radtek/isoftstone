#ifndef CLASS_CBREAKER_AUTO_H
#define CLASS_CBREAKER_AUTO_H
...
struct CBreaker_Struct
{
	...
	CBreaker_Struct& operator=(const CBreaker_Struct& cp)
	{
		this->af = 		cp.af;
		this->app = 		cp.app;
...
class CCBreaker_Auto : public ISerialize,public GSerialize,public CGraphicsItemBase 
{
public:
	...
	CBreaker_Struct getInfo()
	{
		return m_Info;
	}
protected:

	CBreaker_Struct m_Info ;
};
