#ifndef CLASS_CIRCLE_AUTO_H
#define CLASS_CIRCLE_AUTO_H
...
struct Circle_Struct
{
	...
	Circle_Struct& operator=(const Circle_Struct& cp)
	{
		this->af = 		cp.af;
		this->cx = 		cp.cx;
		this->cy = 		cp.cy;
...
class CCircle_Auto : public ISerialize,public GSerialize,public CGraphicsItemBase 
{
public:
	...
	Circle_Struct getInfo()
	{
		return m_Info;
	}
protected:

	Circle_Struct m_Info ;
};
