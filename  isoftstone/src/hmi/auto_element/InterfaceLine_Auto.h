#ifndef CLASS_INTERFACELINE_AUTO_H
#define CLASS_INTERFACELINE_AUTO_H
...
struct InterfaceLine_Struct
{
	...
	InterfaceLine_Struct& operator=(const InterfaceLine_Struct& cp)
	{
		this->af = 		cp.af;
		this->app1 = 		cp.app1;
		this->app2 = 		cp.app2;
...
class CInterfaceLine_Auto : public ISerialize,public GSerialize,public CGraphicsItemBase 
{
public:
	...
	InterfaceLine_Struct getInfo()
	{
		return m_Info;
	}
protected:

	InterfaceLine_Struct m_Info ;
};
