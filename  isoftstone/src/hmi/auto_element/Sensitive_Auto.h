#ifndef CLASS_SENSITIVE_AUTO_H
#define CLASS_SENSITIVE_AUTO_H
...
struct Sensitive_Struct
{
	...
	Sensitive_Struct& operator=(const Sensitive_Struct& cp)
	{
		this->af = 		cp.af;
		this->app = 		cp.app;
...
class CSensitive_Auto : public ISerialize,public GSerialize,public CGraphicsItemBase 
{
public:
	...
	Sensitive_Struct getInfo()
	{
		return m_Info;
	}
protected:

	Sensitive_Struct m_Info ;
};
