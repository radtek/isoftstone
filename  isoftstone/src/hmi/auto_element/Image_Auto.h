#ifndef CLASS_IMAGE_AUTO_H
#define CLASS_IMAGE_AUTO_H
...
struct Image_Struct
{
	...
	Image_Struct& operator=(const Image_Struct& cp)
	{
		this->af = 		cp.af;
		this->ahref = 		cp.ahref;
		this->fc = 		cp.fc;
...
class CImage_Auto : public ISerialize,public GSerialize,public CGraphicsItemBase 
{
public:
