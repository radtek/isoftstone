#ifndef CLASS_DCDOT_AUTO_H
#define CLASS_DCDOT_AUTO_H
...
struct DcDot_Struct
{
	...
	DcDot_Struct& operator=(const DcDot_Struct& cp)
	{
		this->af = 		cp.af;
		this->d = 		cp.d;
		this->fc = 		cp.fc;
...
class CDcDot_Auto : public ISerialize,public GSerialize,public CGraphicsItemBase 
{
public:
