#ifndef CLASS_CT_AUTO_H
#define CLASS_CT_AUTO_H
...
struct CT_Struct
{
	...
	CT_Struct& operator=(const CT_Struct& cp)
	{
		this->af = 		cp.af;
...
class CCT_Auto : public ISerialize,public GSerialize,public CGraphicsItemBase 
{
public:
