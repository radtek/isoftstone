#ifndef CLASS_REACTOR_S_AUTO_H
#define CLASS_REACTOR_S_AUTO_H
...
struct Reactor_S_Struct
{
	...
	Reactor_S_Struct& operator=(const Reactor_S_Struct& cp)
	{
		this->af = 		cp.af;
...
class CReactor_S_Auto : public ISerialize,public GSerialize,public CGraphicsItemBase 
{
public:
	...
	Reactor_S_Struct getInfo()
	{
		return m_Info;
	}
protected:

	Reactor_S_Struct m_Info ;
};
