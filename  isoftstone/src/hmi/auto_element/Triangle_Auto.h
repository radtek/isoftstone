#ifndef CLASS_TRIANGLE_AUTO_H
#define CLASS_TRIANGLE_AUTO_H
...
struct Triangle_Struct
{
	...
	Triangle_Struct& operator=(const Triangle_Struct& cp)
	{
		this->af = 		cp.af;
		this->fc = 		cp.fc;
		this->fm = 		cp.fm;
...
class CTriangle_Auto : public ISerialize,public GSerialize,public CGraphicsItemBase 
{
public:
	...
	Triangle_Struct getInfo()
	{
		return m_Info;
	}
protected:

	Triangle_Struct m_Info ;
};
