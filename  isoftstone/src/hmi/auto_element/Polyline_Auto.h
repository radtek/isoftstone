#ifndef CLASS_POLYLINE_AUTO_H
#define CLASS_POLYLINE_AUTO_H
...
struct Polyline_Struct
{
	...
	Polyline_Struct& operator=(const Polyline_Struct& cp)
	{
		this->af = 		cp.af;
		this->d = 		cp.d;
		this->fc = 		cp.fc;
...
class CPolyline_Auto : public ISerialize,public GSerialize,public CGraphicsItemBase 
{
public:
	...
	Polyline_Struct getInfo()
	{
		return m_Info;
	}
protected:

	Polyline_Struct m_Info ;
};
