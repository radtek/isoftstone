#ifndef CLASS_ROUNDRECT_AUTO_H
#define CLASS_ROUNDRECT_AUTO_H
...
struct Roundrect_Struct
{
	...
	Roundrect_Struct& operator=(const Roundrect_Struct& cp)
	{
		this->af = 		cp.af;
		this->fc = 		cp.fc;
		this->fm = 		cp.fm;
...
class CRoundrect_Auto : public ISerialize,public GSerialize,public CGraphicsItemBase 
{
public:
	...
	Roundrect_Struct getInfo()
	{
		return m_Info;
	}
protected:

	Roundrect_Struct m_Info ;
};
