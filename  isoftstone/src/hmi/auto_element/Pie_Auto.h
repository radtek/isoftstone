#ifndef CLASS_PIE_AUTO_H
#define CLASS_PIE_AUTO_H
...
struct Pie_Struct
{
	...
	Pie_Struct& operator=(const Pie_Struct& cp)
	{
		...
		this->app1 = 		cp.app1;
		this->app2 = 		cp.app2;
		this->color0 = 		cp.color0;
		this->color1 = 		cp.color1;
		this->color2 = 		cp.color2;
		this->fc = 		cp.fc;
		this->fm = 		cp.fm;
		this->h = 		cp.h;
		this->id = 		cp.id;
		this->keyid0 = 		cp.keyid0;
		...
		this->p_ReportType0 = 		cp.p_ReportType0;
...
class CPie_Auto : public ISerialize,public GSerialize,public CGraphicsItemBase 
{
public:
	...
	virtual void serialize(xml_node<char>* node) const
	{
		...
		attr = new xml_attribute<char>();
		attr->name( "app0" );
		attr->value( m_Info.app0.toLocal8Bit().data() );
		node->append_attribute(attr) ;
		...
		attr = new xml_attribute<char>();
		attr->name( "app2" );
		attr->value(QString::number(m_Info.app2).toLocal8Bit().data());
		node->append_attribute(attr) ;

		attr = new xml_attribute<char>();
		attr->name( "color0" );
		attr->value( m_Info.color0.toLocal8Bit().data() );
		node->append_attribute(attr) ;

		attr = new xml_attribute<char>();
		attr->name( "color1" );
		attr->value( m_Info.color1.toLocal8Bit().data() );
		node->append_attribute(attr) ;

		attr = new xml_attribute<char>();
		attr->name( "color2" );
		attr->value( m_Info.color2.toLocal8Bit().data() );
		node->append_attribute(attr) ;
		...
		attr = new xml_attribute<char>();
		attr->name( "keyid0" );
		attr->value( m_Info.keyid0.toLocal8Bit().data() );
		node->append_attribute(attr) ;
		...
		attr = new xml_attribute<char>();
		attr->name( "num" );
		attr->value( m_Info.num.toLocal8Bit().data() );
		node->append_attribute(attr) ;

		attr = new xml_attribute<char>();
		attr->name( "number" );
		attr->value( m_Info.number.toLocal8Bit().data() );
		node->append_attribute(attr) ;
		...
		attr = new xml_attribute<char>();
		attr->name( "p_ReportType0" );
		attr->value( m_Info.p_ReportType0.toLocal8Bit().data() );
		node->append_attribute(attr) ;
		...
		attr = new xml_attribute<char>();
		attr->name( "state0" );
		attr->value( m_Info.state0.toLocal8Bit().data() );
		node->append_attribute(attr) ;
		...
		attr = new xml_attribute<char>();
		attr->name( "voltype0" );
		attr->value( m_Info.voltype0.toLocal8Bit().data() );
		node->append_attribute(attr) ;
	...
	virtual void deserialize( xml_node<char>* node)
	{
		...
		attr = node->first_attribute("app0");
		if(attr)
		{
			 m_AttrInfo["app0"] = QString(attr->value());
			 m_Info.app0 = QObject::tr(attr->value());
		}
		...
		attr = node->first_attribute("app2");
		if(attr)
		{
			 m_AttrInfo["app2"] = QString(attr->value());
			 m_Info.app2 = QString(attr->value()).toULongLong();
		}

		attr = node->first_attribute("color0");
		if(attr)
		{
			 m_AttrInfo["color0"] = QString(attr->value());
			 m_Info.color0 = QObject::tr(attr->value());
		}

		attr = node->first_attribute("color1");
		if(attr)
		{
			 m_AttrInfo["color1"] = QString(attr->value());
			 m_Info.color1 = QObject::tr(attr->value());
		}

		attr = node->first_attribute("color2");
		if(attr)
		{
			 m_AttrInfo["color2"] = QString(attr->value());
			 m_Info.color2 = QObject::tr(attr->value());
		}
		...
		attr = node->first_attribute("keyid0");
		if(attr)
		{
			 m_AttrInfo["keyid0"] = QString(attr->value());
			 m_Info.keyid0 = QObject::tr(attr->value());
		}
		...
		attr = node->first_attribute("num");
		if(attr)
		{
			 m_AttrInfo["num"] = QString(attr->value());
			 m_Info.num = QObject::tr(attr->value());
		}

		attr = node->first_attribute("number");
		if(attr)
		{
			 m_AttrInfo["number"] = QString(attr->value());
			 m_Info.number = QObject::tr(attr->value());
		}
		...
		attr = node->first_attribute("p_ReportType0");
		if(attr)
		{
			 m_AttrInfo["p_ReportType0"] = QString(attr->value());
			 m_Info.p_ReportType0 = QObject::tr(attr->value());
		}
		...
		attr = node->first_attribute("state0");
		if(attr)
		{
			 m_AttrInfo["state0"] = QString(attr->value());
			 m_Info.state0 = QObject::tr(attr->value());
		}
		...
		attr = node->first_attribute("voltype0");
		if(attr)
		{
			 m_AttrInfo["voltype0"] = QString(attr->value());
			 m_Info.voltype0 = QObject::tr(attr->value());
		}
