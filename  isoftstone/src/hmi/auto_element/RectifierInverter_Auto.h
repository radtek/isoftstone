#ifndef CLASS_RECTIFIERINVERTER_AUTO_H
#define CLASS_RECTIFIERINVERTER_AUTO_H
...
struct RectifierInverter_Struct
{
	uint  af;
	QString  devref;
	QColor  fc;
	...
	RectifierInverter_Struct& operator=(const RectifierInverter_Struct& cp)
	{
		this->af = 		cp.af;
...
class CRectifierInverter_Auto : public ISerialize,public GSerialize,public CGraphicsItemBase 
{
public:
	...
	RectifierInverter_Struct getInfo()
	{
		return m_Info;
	}
protected:

	RectifierInverter_Struct m_Info ;
};
