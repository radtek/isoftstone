#ifndef CLASS_CAPACITOR_P_AUTO_H
#define CLASS_CAPACITOR_P_AUTO_H
...
struct Capacitor_P_Struct
{
	...
	Capacitor_P_Struct& operator=(const Capacitor_P_Struct& cp)
	{
		this->af = 		cp.af;
		this->app = 		cp.app;
...
class CCapacitor_P_Auto : public ISerialize,public GSerialize,public CGraphicsItemBase 
{
public:
	...
	Capacitor_P_Struct getInfo()
	{
		return m_Info;
	}
protected:

	Capacitor_P_Struct m_Info ;
};
