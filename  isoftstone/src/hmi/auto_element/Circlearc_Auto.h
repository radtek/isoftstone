#ifndef CLASS_CIRCLEARC_AUTO_H
#define CLASS_CIRCLEARC_AUTO_H
...
struct Circlearc_Struct
{
	...
	Circlearc_Struct& operator=(const Circlearc_Struct& cp)
	{
		this->a1 = 		cp.a1;
		this->a2 = 		cp.a2;
		this->af = 		cp.af;
		...
		this->ls = 		cp.ls;
		this->lw = 		cp.lw;
		this->p_ArcShape = 		cp.p_ArcShape;
		this->p_AssFlag = 		cp.p_AssFlag;
		this->p_DrawFlag = 		cp.p_DrawFlag;
...
class CCirclearc_Auto : public ISerialize,public GSerialize,public CGraphicsItemBase 
{
public:
	virtual void serialize(QDataStream& out) const
	{
		...
		out << m_Info.ls;
		out << m_Info.lw;
		out << m_Info.p_ArcShape;
		out << m_Info.p_AssFlag;
		out << m_Info.p_DrawFlag;
	...
	virtual void serialize(xml_node<char>* node) const
	{
		...
		attr->name( "a1" );
		attr->value( m_Info.a1.toLocal8Bit().data() );
		node->append_attribute(attr) ;

		attr = new xml_attribute<char>();
		attr->name( "a2" );
		attr->value( m_Info.a2.toLocal8Bit().data() );
		node->append_attribute(attr) ;
		...
		attr = new xml_attribute<char>();
		attr->name( "p_ArcShape" );
		attr->value( m_Info.p_ArcShape.toLocal8Bit().data() );
		node->append_attribute(attr) ;
		...
		attr = new xml_attribute<char>();
		attr->name( "p_DrawFlag" );
		attr->value( m_Info.p_DrawFlag.toLocal8Bit().data() );
		node->append_attribute(attr) ;
		...
		attr = new xml_attribute<char>();
		attr->name( "r" );
		attr->value( m_Info.r.toLocal8Bit().data() );
		node->append_attribute(attr) ;
	...
	virtual void deserialize( xml_node<char>* node)
	{
		...
		attr = node->first_attribute("a1");
		if(attr)
		{
			 m_AttrInfo["a1"] = QString(attr->value());
			 m_Info.a1 = QObject::tr(attr->value());
		}

		attr = node->first_attribute("a2");
		if(attr)
		{
			 m_AttrInfo["a2"] = QString(attr->value());
			 m_Info.a2 = QObject::tr(attr->value());
		}
		...
		attr = node->first_attribute("p_ArcShape");
		if(attr)
		{
			 m_AttrInfo["p_ArcShape"] = QString(attr->value());
			 m_Info.p_ArcShape = QObject::tr(attr->value());
		}
		...
		attr = node->first_attribute("p_DrawFlag");
		if(attr)
		{
			 m_AttrInfo["p_DrawFlag"] = QString(attr->value());
			 m_Info.p_DrawFlag = QObject::tr(attr->value());
		}
		...
		if(attr)
		{
			 m_AttrInfo["r"] = QString(attr->value());
			 m_Info.r = QObject::tr(attr->value());
		}
	...
	Circlearc_Struct getInfo()
	{
		return m_Info;
	}
protected:

	Circlearc_Struct m_Info ;
};
