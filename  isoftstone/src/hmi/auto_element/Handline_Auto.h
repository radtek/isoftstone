#ifndef CLASS_HANDLINE_AUTO_H
#define CLASS_HANDLINE_AUTO_H
...
struct Handline_Struct
{
	...
	Handline_Struct& operator=(const Handline_Struct& cp)
	{
		this->af = 		cp.af;
		this->d = 		cp.d;
		this->fc = 		cp.fc;
...
class CHandline_Auto : public ISerialize,public GSerialize,public CGraphicsItemBase 
{
public:
	...
	Handline_Struct getInfo()
	{
		return m_Info;
	}
protected:

	Handline_Struct m_Info ;
};
