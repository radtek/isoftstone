#ifndef CLASS_BUS_AUTO_H
#define CLASS_BUS_AUTO_H
...
struct Bus_Struct
{
	...
	Bus_Struct& operator=(const Bus_Struct& cp)
	{
		this->af = 		cp.af;
		this->app = 		cp.app;
		this->d = 		cp.d;
...
class CBus_Auto : public ISerialize,public GSerialize,public CGraphicsItemBase 
{
public:
