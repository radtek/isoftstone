#ifndef CLASS_TERMINAL_AUTO_H
#define CLASS_TERMINAL_AUTO_H
...
struct Terminal_Struct
{
	...
	Terminal_Struct& operator=(const Terminal_Struct& cp)
	{
		this->af = 		cp.af;
...
class CTerminal_Auto : public ISerialize,public GSerialize,public CGraphicsItemBase 
{
public:
	...
	Terminal_Struct getInfo()
	{
		return m_Info;
	}
protected:

	Terminal_Struct m_Info ;
};
