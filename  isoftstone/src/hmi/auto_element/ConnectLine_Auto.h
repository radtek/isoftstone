#ifndef CLASS_CONNECTLINE_AUTO_H
#define CLASS_CONNECTLINE_AUTO_H
...
struct ConnectLine_Struct
{
	...
	ConnectLine_Struct& operator=(const ConnectLine_Struct& cp)
	{
		this->af = 		cp.af;
		this->d = 		cp.d;
		this->fc = 		cp.fc;
...
class CConnectLine_Auto : public ISerialize,public GSerialize,public CGraphicsItemBase 
{
public:
	...
	ConnectLine_Struct getInfo()
	{
		return m_Info;
	}
protected:

	ConnectLine_Struct m_Info ;
};
