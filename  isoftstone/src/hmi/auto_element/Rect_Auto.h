#ifndef CLASS_RECT_AUTO_H
#define CLASS_RECT_AUTO_H
...
struct Rect_Struct
{
	...
	Rect_Struct& operator=(const Rect_Struct& cp)
	{
		this->af = 		cp.af;
		this->fc = 		cp.fc;
		this->fm = 		cp.fm;
...
class CRect_Auto : public ISerialize,public GSerialize,public CGraphicsItemBase 
{
public:
