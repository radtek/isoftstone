#ifndef CLASS_STATE_AUTO_H
#define CLASS_STATE_AUTO_H
...
struct State_Struct
{
	...
	State_Struct& operator=(const State_Struct& cp)
	{
		this->af = 		cp.af;
		this->app = 		cp.app;
...
class CState_Auto : public ISerialize,public GSerialize,public CGraphicsItemBase 
{
public:
