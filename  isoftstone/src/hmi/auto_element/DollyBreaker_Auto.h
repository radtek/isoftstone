#ifndef CLASS_DOLLYBREAKER_AUTO_H
#define CLASS_DOLLYBREAKER_AUTO_H
...
struct DollyBreaker_Struct
{
	...
	DollyBreaker_Struct& operator=(const DollyBreaker_Struct& cp)
	{
		this->af = 		cp.af;
		this->app1 = 		cp.app1;
		this->app2 = 		cp.app2;
...
class CDollyBreaker_Auto : public ISerialize,public GSerialize,public CGraphicsItemBase 
{
public:
	...
	DollyBreaker_Struct getInfo()
	{
		return m_Info;
	}
protected:

	DollyBreaker_Struct m_Info ;
};
