#ifndef CLASS_POWERFLOW_AUTO_H
#define CLASS_POWERFLOW_AUTO_H
...
struct PowerFlow_Struct
{
	...
	PowerFlow_Struct& operator=(const PowerFlow_Struct& cp)
	{
		this->af = 		cp.af;
...
class CPowerFlow_Auto : public ISerialize,public GSerialize,public CGraphicsItemBase 
{
public:
	...
	PowerFlow_Struct getInfo()
	{
		return m_Info;
	}
protected:

	PowerFlow_Struct m_Info ;
};
