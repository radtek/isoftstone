#ifndef CLASS_POLYGON_AUTO_H
#define CLASS_POLYGON_AUTO_H
...
struct Polygon_Struct
{
	...
	Polygon_Struct& operator=(const Polygon_Struct& cp)
	{
		this->af = 		cp.af;
		this->d = 		cp.d;
		this->fc = 		cp.fc;
...
class CPolygon_Auto : public ISerialize,public GSerialize,public CGraphicsItemBase 
{
public:
	...
	Polygon_Struct getInfo()
	{
		return m_Info;
	}
protected:

	Polygon_Struct m_Info ;
};
