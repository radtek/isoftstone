...
class LIBCORE_EXPORT CMarkupSTL  
{
public:
	...
	int GetDeviceType() { return m_nNodeType; };
...
//#endif
	...
	enum MarkupDeviceFlagsInternal
	{
	...
	static std::string x_GetLastError();
};
