...
class LIBCORE_EXPORT MibExtLoad
{
public:
...
class LIBCORE_EXPORT MibII: public MibExtLoad
{
public:
	MibII();
	~MibII();
...
class LIBCORE_EXPORT CMibWrapper
{
public:
	...
	BOOL CheckRegist (LPCSTR szCode);

	std::string getRegist();
};
